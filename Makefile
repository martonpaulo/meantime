...
social-card: ## Render site/social-card.jpg from design/social-card/social-card.html (on a Mac)
	...
	@magick $(TMPDIR)meantime-card.png -strip -quality 92 -sampling-factor 4:4:4 -interlace Plane site/social-card.jpg
