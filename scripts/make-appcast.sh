...
ZIP_PATH="$3"
SIGNATURE_ATTRS="$4"
URL="https://github.com/martonpaulo/meantime/releases/download/v$VERSION/$(basename "$ZIP_PATH")"
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <link>https://github.com/martonpaulo/meantime</link>
    <description>Most recent updates to Meantime</description>
